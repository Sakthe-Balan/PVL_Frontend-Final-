    ...
    <div className="border-2 w-1/3 m-1 rounded-lg flex justify-center flex-wrap p-5">
      ...
      <div className="flex flex-wrap justify-center w-full align-middle">
        <p className="w-1/2">
          ...
          <button className=" bg-green-500 w-full rounded-full p-2 text-white text-lg font-bold relative right-4">
            {props.val1}
          </button>
        </p>
        <p className="w-1/2">
          <p className="">
            ...
            <button className=" bg-green-500 w-full rounded-full p-2 text-white text-lg font-bold relative left-4">
              {props.val2}
            </button>
          </p>
        </p>
        ...
        <p className="w-1/2">
          ...
          <button className="border-blue-700 border-2 rounded-3xl bg-indigo-800 text-white p-2">
            I am a button
          </button>
        </p>
        <p className="w-1/2">
